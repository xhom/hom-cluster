...
public class Result {
    ...
    public static Result success(ErrorCodeEnum codeEnum, Object data){
        return new Result(true, codeEnum.getCode(), codeEnum.getMsg(), data);
    }


    public static Result failure(){
        return failure(ErrorCodeEnum.FAILURE);
    }
    public static Result failure(String message){
        return failure(message, null);
    }
    public static Result failure(String message, Object data){
        return failure(ErrorCodeEnum.FAILURE.getCode(), message, data);
    }
    public static Result failure(ErrorCodeEnum codeEnum){
        return failure(codeEnum, null);
    }
    public static Result failure(ErrorCodeEnum codeEnum, Object data){
